#!/usr/bin/env node
/**
 * Phase 7: Test NEWGEN Research Pipeline (alternative to TCS due to HTTP 403)
 */
...
const testNEWGENResearch = async () => {
  console.log('\n' + '='.repeat(80));
  console.log('PHASE 7 NEWGEN RESEARCH PIPELINE TEST');
  ...
  console.log(`Existing NEWGEN promises before research: ${beforeCount}`);

  try {
    console.log('\nStarting NEWGEN research pipeline...\n');
    ...
    console.log(`\n\nExisting NEWGEN promises after research: ${afterCount}`);
