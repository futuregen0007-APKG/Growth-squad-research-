...
// Convert STOCKS array to SUPPORTED_STOCKS object for easier lookup
export const SUPPORTED_STOCKS = STOCKS.reduce((acc, stock) => {
  acc[stock.ticker] = {
    name: stock.name,
    sector: stock.sector,
    currency: 'INR'
...
// Fallback stock data with detailed information
